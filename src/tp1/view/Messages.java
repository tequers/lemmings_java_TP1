...
//3.0
	...
	//SET ROLE COMMAND
	public static final String COMMAND_SET_ROLE_COMMAND_NAME = "SetRole";
...
//Roles
	...
	public static final String PARACHUTER_ROL_HELP_NAME = "[P]arachuter";
	public static final String PARACHUTER_ROL_HELP = "Lemming falls with a parachute";
	
	public static final String DOWN_CAVER_ROL_SYMBOL = "DC";
	public static final String DOWN_CAVER_ROL_NAME = "DownCaver";
	public static final String  DOWN_CAVER_ROL_HELP_NAME = "[D]own [C]aver";
	public static final String  DOWN_CAVER_ROL_HELP = "Lemming caves downwards";
